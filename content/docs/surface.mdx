...
The callable **`Surface`** component is **`Surface.Root`**.

<auto-type-table path="../../src/components/surface/surface.types.ts" name="SurfaceRootProps" />
...
`none` · `thinnest` · `thinner` · `thin` · `normal` · `thick` · `thicker` · `thickest`
