---
title: Ornament
description: Vision Pro–style floating navigation rail that auto-expands on hover or focus to reveal labels alongside icons.
icon: PanelLeft
---
...
Wraps the leading icon. Accepts standard **`React.HTMLAttributes<HTMLDivElement>`** plus the required **`icon`** node.

<auto-type-table path="../../src/components/ornament/ornament.types.ts" name="OrnamentTabIconProps" />
