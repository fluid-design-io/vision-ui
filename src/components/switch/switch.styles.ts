...
export const switchVariants = cva(
	cn(
		'relative inline-flex shrink-0 cursor-pointer items-center rounded-full p-[var(--switch-padding)]',
		...
		'[--switch-padding:2px] [--switch-thumb-size:27px]',
	),
	{
		variants: {
			size: {
				default: cn('h-[31px] w-[51px]', '[--switch-padding:2px] [--switch-thumb-size:27px]'),
				sm: cn('h-[26px] w-[44px]', '[--switch-padding:2px] [--switch-thumb-size:22px]'),
			},
		},
		defaultVariants: {
			size: 'default',
